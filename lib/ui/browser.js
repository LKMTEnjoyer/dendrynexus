...
(function($) {
  ...
  BrowserUserInterface.prototype.autosave = function() {
      var oldData_a2 = localStorage[this.save_prefix + '_a2'];
      var oldData_a1 = localStorage[this.save_prefix + '_a1'];
      var oldData_a0 = localStorage[this.save_prefix + '_a0'];
      if (oldData_a2) {
          localStorage[this.save_prefix + '_a3'] = oldData_a2;
          localStorage[this.save_prefix + '_timestamp_a3'] = localStorage[this.save_prefix + '_timestamp_a2'];
      }
      if (oldData_a1) {
          localStorage[this.save_prefix + '_a2'] = oldData_a1;
          localStorage[this.save_prefix + '_timestamp_a2'] = localStorage[this.save_prefix + '_timestamp_a1'];
      }
      if (oldData_a0) {
          localStorage[this.save_prefix + '_a1'] = oldData_a0;
